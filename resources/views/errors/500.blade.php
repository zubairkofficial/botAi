...
@section('title')
    500 {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
        ...
        <div class="container">
            <div class="row g-3">
                <div class="content-404 text-center">
                    <img src="{{ staticAsset('frontend/default/assets/img/website/500.png') }}" alt="not found"
                        class="img-fluid h-75 w-25">
                    <h2 class="mt-4">Sorry, Internal Server Error</h2>
