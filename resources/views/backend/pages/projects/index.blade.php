                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('All Projects') }}</h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                                        ...
                                        <div class="input-group">
                                            <select class="form-select select2" name="content_type"
                                                ...
                                                <option value="speech_to_text"
                                                    @isset($content_type)
                                                     @if ($content_type == 'speech_to_text') selected @endif
                                                    @endisset>
                                                    {{ localize('Speech To Text') }}</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <!--pagination start-->
                        <x-pagination-component :list='$projects' />
                        <!--pagination end-->
                    </div>
                </div>
            </div>
