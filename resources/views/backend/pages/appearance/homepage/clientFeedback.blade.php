                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('What Clients Say') }}</h1>
                                <ol class="breadcrumb breadcrumb-angle text-muted">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('writebot.dashboard') }}">{{ localize('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item">{{ localize('What Clients Say') }}</li>
                                </ol>
                            </div>
                            <div class="tt-action">
                            </div>
                                ...
                                <table class="table tt-footable" data-use-parent-width="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-breakpoints="xs sm md lg xl">{{ localize('Heading') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($feedback as $key => $singleFeedback)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    {{ $singleFeedback->designation }}
                                                </td>

                                                <td class="align-middle">
                                                    {{ $singleFeedback->heading }}
                                                </td>
